...
$sql = "SELECT giver_dash.start,giver_dash.destination,giver_dash.Giver_Name,trip_giver.imagename,payment.Id,payment.payment_status,payment.Taker_Name,giver_dash.price,giver_dash.time,giver_dash.date,payment.Transaction_id,trip_taker.address As Address,trip_taker.native As Native,trip_taker.mobno As Mobno,trip_taker.nationality As Nationality,trip_giver.address,trip_giver.native,trip_giver.mobno,trip_giver.nationality  FROM giver_dash,payment,trip_giver,trip_taker WHERE giver_dash.Giver_Name= payment.Giver_Name AND trip_giver.Giver_Name= giver_dash.Giver_Name AND payment.Taker_Name='".$username."' AND trip_taker.Taker_Name='".$username."' AND payment.payment_status='successfull' AND payment.Taker_Name='".$username."'";
