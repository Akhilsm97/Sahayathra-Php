...
<head>
    ...
    <style>
    .card-3 .card-heading {
  background: url("../images/Giver.jpg") top left/cover no-repeat;
  display: table-cell;
  width: 50%;
}
    </style>
...
<body>
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3" style="margin-top:-50px;">
                <div class="card-heading" ></div>
                <div class="card-body">
                <h2 class="title">Giver Registration </h2>
                    <form method="POST" action=""  enctype="multipart/form-data" name = "myform" onsubmit = " return validate()">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Name" name="Giver_Name">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="car_type">
                                    <option disabled="disabled" selected="selected">Vehicle Type</option>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name="submit"  data-toggle="modal" data-target="#exampleModalCenter" onclick="ValidateNo();">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
...
//function for saving the uploaded images in a specific folder
    ...
    $password = $_POST['password'];
	 $sql =  "INSERT INTO `trip_giver`(`Giver_Name`, `aaddhar`, `address`, `mobno`, `native`, `nationality`, `car_type`, `imagename`, `password`) VALUES ('$Name','$aaddhar','$address','$mobno','$native','$nationality','$car_type','$filename','$password')";
   $result = mysqli_query($conn,$sql);
   $sql1 ="INSERT INTO `login_table`(`Name`, `password`, `type`, `status`) VALUES ('$Name','$password','Giver','0')";
